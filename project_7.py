...
console_texts={
    '/LV': {
        ...
        'Error_type':'Kļūda! Nepazīstams ziņojuma tips. Lūdzu, sūtiet tikai teksta ziņojumus.',
    ...
    '/ENG': {
        ...
        'Error_type': 'Error! Unknown message type. Please send here only text messages',
    ...
    '/RU': {
        ...
        'Error_type':'Ошибка! Неизвестный тип сообщения. Пожалуйста, присылайте только текстовые сообщения!',
...
# @bot.message_handler(commands=['spoiler', 'nospoiler'])
# def Spoiler_NoSpoiler(message):
#     global text
#     if message == "/spoiler":
#         bot.send_message(message.chat.id, 
#                         f"||{esc(text)}||",
